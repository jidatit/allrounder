...
const PostPage = () => {
  ...
  const getContainerWidth = () => {
    ...
    const baseClasses = {
      ...
      2: "w-full smd:w-[87%] md:w-[65%] lg:w-[60%] xl:w-[50%]", // Full on mobile, 85% on tablet, 70% on desktop, 60% on xl
      3: "w-full smd:w-[78%] md:w-[100%] lg:w-[90%] xl:w-[70%]", // Full on mobile, 90% on tablet, 75% on desktop, 66% on xl
      4: "w-full smd:w-[75%] md:w-[99%] lg:w-[90%] xl:w-[95%]", // Default responsive widths // Full on mobile and tablet, 85% on desktop, 80% on xl
      5: "w-full smd:w-[75%] md:w-[99%] lg:w-[90%] xl:w-[95%]", // Full on mobile and tablet, 90% on desktop, 85% on xl
      6: "w-full smd:w-[75%] md:w-[99%] lg:w-[90%] xl:w-[95%]", // Full on mobile and tablet, 95% on desktop, 90% on xl
      default: "w-full smd:w-[90%] md:w-[99%] lg:w-[95%] xl:w-[95%]", // Default responsive widths
    };
