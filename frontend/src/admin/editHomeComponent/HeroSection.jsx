...
const handleInputChange = (e) => {
  ...
  //             <div className="mt-4 ml-8 border">
  //               <h3 className="text-xl">Upload Display Image</h3>
  //               <div
  ...
  //               <h4 className=" mb-4">Edit Display Text</h4>
  //               <input className="w-full p-2 border border-gray-500 rounded-full text-sm"
  ...
  //                  <div className='flex justify-center items-center mt-4>' >
  //                   <button
  //             className="mt-2 bg-red-500 text-white px-2 py-2 rounded-full text-sm"
            ...
            <Panel className="font-bold text-xl" header="Hero Section" key="1">
              <div className="flex flex-wrap md:flex-nowrap space-y-4 md:space-y-0 md:space-x-4">
                ...
                <div className="w-full md:w-1/2 p-4">
                  ...
                  <input
                    className="w-full p-2 border border-gray-500 rounded-full text-sm"
                    placeholder="Write here"
                    value={textInput}
                    onChange={handleInputChange}
                    onKeyDown={handleKeyDown}
