  ...
  return (
    <>
      {loading ? (
        ...
        <header className="sticky top-0 z-50 bg-[#ffffff] py-4">
          <section className="md:flex items-center justify-between sm:px-2 lg:px-12 custom-regular hidden mx-auto w-screen">
            <Link to={"/"}>
                  ...
                  {MenuItems.map((Items, index) => (
                    <li key={index}>
                      {Items ? (
                        ...
                        <span className="text-gray-500 cursor-not-allowed custom-reg">
                          {Items}
                        </span>
                      )}
                    </li>
